...
int main(void) {
    ...
    double lambda = 1.0e-1, delta = 1.2224;
    ...
    double C_D_inicial = 1.86e8, C_Dose2 = 0, C_Dose3 = 0, C_D, C_T = 0.0, C_M = 0.0, C_E = 0.0;
    
    int n = 1999, i, j, limiar;
    double xbar = 0.42, hx, aux[2001], T[2001], T1[2001], T2[2001], T3[2001], T4[2001];
    ...
    FILE *arq, *d1, *d2, *d3, *d4, *d5, *d6, *d7, *d8, *d9, *d10;

    arq = fopen("pb1_dados.txt", "w");
    d1 = fopen("pb1_dados_tumor_t0.txt", "w");
    d2 = fopen("pb1_dados_tumor_t30.txt", "w");
    d3 = fopen("pb1_dados_tumor_t60.txt", "w");
    d4 = fopen("pb1_dados_tumor_t90.txt", "w");
    d5 = fopen("pb1_dados_tumor_t180.txt", "w");
    d9 = fopen("pb1_dados_tumor_t360.txt", "w");
    d10 = fopen("pb1_dados_tumor_t540.txt", "w");
    d6 = fopen("pb1_dados_heat_taxa.txt", "w");
    d7 = fopen("pb1_dados_heat_efeito.txt", "w");
    d8 = fopen("pb1_dados_barplot.txt", "w");
