...
int main(void) {
    ...
    double C_D_inicial = 4.2e7, C_Dose2 = 0, C_Dose3 = 0, C_D, C_T = 0.0, C_M = 0.0;
    ...
    arq = fopen("pc2_dados.txt", "w");
    d1 = fopen("pc2_dados_tumor_t0.txt", "w");
    d2 = fopen("pc2_dados_tumor_t30.txt", "w");
    d3 = fopen("pc2_dados_tumor_t60.txt", "w");
    d4 = fopen("pc2_dados_tumor_t90.txt", "w");
    d5 = fopen("pc2_dados_tumor_t180.txt", "w");
    d6 = fopen("pc2_dados_heat_taxa.txt", "w");
    d7 = fopen("pc2_dados_heat_efeito.txt", "w");
    d8 = fopen("pc2_dados_barplot.txt", "w");
